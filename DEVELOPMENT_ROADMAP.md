...
Build only after Phase 6 certification and `PAYMENT_ARCHITECTURE.md` approval:
...
3. Begin Phase 7 money movement on a new phase branch.
4. Merge Phase 7 only after money movement certification passes.
