...
export default async function OfflinePage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background px-4 text-center text-foreground">
      ...
      <h1 className="mt-6 text-2xl font-semibold text-foreground">{t("system.offline_title")}</h1>
      <p className="mt-3 max-w-md text-muted-foreground">{t("system.offline_body")}</p>
    </main>
  );
}
