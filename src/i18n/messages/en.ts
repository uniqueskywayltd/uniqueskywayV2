...
export const enMessages = {
  ...
  "auth.verify_queued":
    "Verification code queued for {email}. Choose your investment package after you verify.",
  ...
  "auth.verify_modal_body": "We have sent a verification code to:",
  "auth.verify_modal_enter": "Enter the code below.",
  "auth.verify_modal_link_hint": "You may also click the Verify Email button inside the email.",
