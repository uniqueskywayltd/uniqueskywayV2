          ...
          <div className="relative mx-auto w-full max-w-md lg:max-w-none">
            ...
            >
              ...
              <div className="relative aspect-[16/11] w-full sm:aspect-[16/10]">
                ...
                <div className="absolute top-3 right-3 rounded-lg border border-white/30 bg-white/95 px-3 py-2.5 shadow-md backdrop-blur-sm sm:top-4 sm:right-4 dark:border-border/60 dark:bg-card/95">
